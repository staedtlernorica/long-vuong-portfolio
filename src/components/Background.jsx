export default function BackgroundScatter() {
  const svgIcon = `<?xml version="1.0" encoding="utf-8"?><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 122.59" style="enable-background:new 0 0 122.88 122.59" xml:space="preserve"><style type="text/css"><![CDATA[
  ...
  // predefined "scattered" placements (adjust or add entries)
  const spots = [
    { top: '6%', left: '4%', size: 90, rotate: '-12deg', opacity: 0.2 },
    { top: '18%', right: '6%', size: 64, rotate: '8deg', opacity: 0.05 },
    { bottom: '10%', left: '8%', size: 110, rotate: '20deg', opacity: 0.04 },
    { bottom: '18%', right: '12%', size: 72, rotate: '-8deg', opacity: 0.08 },
    { top: '44%', left: '42%', size: 120, rotate: '2deg', opacity: 0.05 },
    { top: '70%', left: '20%', size: 56, rotate: '40deg', opacity: 0.067 },
  ];
  ...
  return (
    ...
    >
      {spots.map((s, i) => {
        ...
        // apply positioning keys (top/bottom/left/right)
        const pos = {};
        ...
        return (
          <div key={i} style={{ ...style, ...pos }} dangerouslySetInnerHTML={{ __html: svgIcon }} />
        );
      })}
    </div>
  );
