  ...
  return (
    <section className="projects">
      ...
      <div className="project">
        <section className="img-title">
          <div className="title">
            ...
            <h6>
              Flask | Python | Pandas | SQLite | JavaScript | Plotly Charting
              Library
            </h6>
            <div className="links">
              <a href="https://hydrochart-vuonglon.pythonanywhere.com/">
                Live Site
              </a>
            </div>
          </div>
        ...
        <div className="description">
          ...
          <p>
            ...
            A full-stack web app that helps Ontario residents compare
            electricity plans using their real usage data. Users upload their
            Green Button XML files, and the app processes the data with Pandas
            and displays cost breakdowns using Plotly.
          </p>
          <br />
          <h6>Project motivation</h6>
          <p>
            The motivation for this project came from a conversation with a
            friend about the energy plans offered by our local electricity
            provider, and which of the three available plans would save them the
            most money. Though I found no difference between the plans in my
            case, my friend happily switched to the more cost-effective plan for
            them (as it allowed them to charge their car for cheaper at night
            🌚⚡).
          </p>
        </div>
      </div>
      ...
      <div className="project">
        <section className="img-title">
          <div className="title">
            ...
            <div className="links">
              <a href="https://ytstats-vuonglon.pythonanywhere.com/">
                Live Site
              </a>
            </div>
          </div>
        ...
        <div className="description">
          ...
          <p>
            ...
            A tool for collecting the metrics of every video in a YouTube
            playlists or channel. Simply paste the URL to the playlist/channel,
            and the app will return a CSV of metric data gathered from the
            YouTube API - ready to be used in visualization exercises or machine
            learning datasets.
          </p>
          <br />
          <h6>Project motivation</h6>
          <p>
            While working on a data visualization project, I needed video
            metrics from a playlist with hundreds of videos in it. Finding no
            tool to automate this process, and faced with the possibility of
            having to repeat this process for a different playlist
            <b>
              <i>again</i>
            </b>
            , I resorted to create this app.
          </p>
        </div>
      </div>
      ...
      <div className="project">
        <section className="img-title">
          <div className="title">
            <h4>Design to Code Conversions (PSD to HTML/CSS)</h4>
            <h6>HTML | CSS | JavaScript | SCSS</h6>
            <div className="links">
              <ul>
                <li>
                  <a href="https://staedtlernorica.github.io/long-vuong-project-one/index.html">
                    Sophie
                  </a>
                </li>
                <li>
                  <a href="https://staedtlernorica.github.io/panda-sanctuary/">
                    Panda Sanctuary
                  </a>
                </li>
                <li>
                  <a href="https://staedtlernorica.github.io/Juno-Project-1/">
                    The Journal
                  </a>
                </li>
              </ul>
        ...
        <div className="description">
          <h6>Overview</h6>
          <p>
            Some of my old "design to code" mock-ups for classes during my time
            at Juno College.
          </p>
        </div>
      </div>
